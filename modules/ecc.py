...
class S256Field(FieldElement): # subclass of FieldElement
...
class S256Point(Point):     #subclass of the Point class
...
class PrivateKey:
    ...
    def sign(self, z):
        k = self.deterministic_k(z)     #not nearly random enough
        r = (k * G).x.num
        k_inv = pow(k, N - 2, N)
